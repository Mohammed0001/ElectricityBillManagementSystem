...
public class viewCustomerBills extends javax.swing.JFrame {

    private User user ;
    ArrayList <Bill> bills ;
    ArrayList <Customer> customers;
    public viewCustomerBills(User user ) {
       this.user = user;
       initComponents();
    ...
    public void viewBills(int id){
        if (user instanceof Customer) {
           bills = Bill.viewBills(user.getId());
        }else{
            bills = Bill.viewBills(id);
        }
    ...
    private void initComponents() {
        ...
        jButton3.setText("Pay Bill With The Team");
        jButton3.setActionCommand("Pay Bill with the Team");
        ...
        jButton4.setText("Pay Bill With Nada");
        jButton4.setActionCommand("Pay Bill with the Team");
